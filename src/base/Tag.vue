<template>
	<div id="Tag">
        ...
        <div class='action'>
            <p class='icon-title text-blue'></p>标签形状
        </div>
        </div>
        ...
        <div class='action'>
            <p class='icon-title text-blue'></p>标签尺寸
        </div>
        </div>
        ...
        <div class="cu-bar bg-white margin-top">
        <div class='action'>
            <p class='icon-title text-blue'></p>标签颜色
        </div>
        </div>
        <div class='padding-sm flex flex-wrap'>
        <div class="padding-xs" v-for="(item, keys) in ColorList" :key="keys">
            <div class='cu-tag' :class="'bg-' + item.name">{{item.title}}</div>
        </div>
        <div class="padding-xs" v-for="(item) in ColorList" :key="item.title">
            <div class='cu-tag light' :class="'bg-' + item.name">{{item.title}}</div>
        </div>
        </div>
        <div class="cu-bar bg-white margin-top">
        <div class='action'>
            <p class='icon-title text-blue'></p>镂空标签
        </div>
        </div>
        <div class='padding-sm flex flex-wrap'>
        <div class="padding-xs" v-for="(item) in ColorList" :key="item.name">
            <div class='cu-tag' :class="'line-' + item.name">{{item.title}}</div>
        </div>
        </div>
        <div class="cu-bar bg-white margin-top">
        <div class='action'>
            <p class='icon-title text-blue'></p>胶囊样式
        </div>
        </div>
        <div class="padding">
        <div class="cu-capsule">
            <div class='cu-tag bg-red'>
            <p class='icon-likefill'></p>
            </div>
        ...
        <div class="cu-bar bg-white margin-top">
        <div class='action'>
            <p class='icon-title text-blue'></p>数字标签
        </div>
        </div>
        ...
        <div class='cu-avatar xl radius' style="background-image:url(https://image.weilanwl.com/img/square-3.jpg);">

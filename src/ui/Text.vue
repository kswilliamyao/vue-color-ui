<template>
	<div id="Text">
       <div class="cu-bar bg-white solid-bottom">
        <div class='action'>
            <p class='icon-title text-blue'></p>文字大小
        </div>
        </div>
        ...
        <div class='solids-bottom padding-xs flex align-center'>
            ...
            <div class='solid-bottom text-xsl padding'>
                <p class=' icon-roundcheckfill text-green'></p>
            </div>
        ...
        <div class='solids-bottom padding-xs flex align-center'>
            ...
            <div class='solid-bottom text-xxl padding'>
                <p class='text-price text-red'>80.00</p>
            </div>
        ...
        <div class='solids-bottom padding-xs flex align-center'>
            ...
            <div class='solid-bottom text-xl padding'>
                <p class='text-black text-bold'>您的订单已提交成功！</p>
            </div>
        ...
        <div class='solids-bottom padding-xs flex align-center'>
            ...
            <div class='solid-bottom text-lg padding'>
                <p class='text-black'>ColorUI组件库</p>
            </div>
        ...
        <div class='solids-bottom padding-xs flex align-center'>
            ...
            <div class='solid-bottom text-sm padding'>
                <p class='text-grey'>衬衫的价格是9磅15便士</p>
            </div>
        ...
        <div class='action'>
            <p class='icon-title text-blue'></p>文字颜色
        </div>
        </div>
        ...
        <div class="cu-bar bg-white solid-bottom margin-top">
        <div class='action'>
            <p class='icon-title text-blue'></p>文字截断
        </div>
        </div>
        ...
        <div class="cu-bar bg-white solid-bottom margin-top">
        <div class='action'>
            <p class='icon-title text-blue'></p>文字对齐
        </div>
        </div>
        <div class='padding bg-white'>
        ...
        <div class="cu-bar bg-white solid-bottom margin-top">
        <div class='action'>
            <p class='icon-title text-blue'></p>特殊文字
        </div>
        </div>
